...
alias glo='git log --all --decorate --no-ext-diff --date=short --since="90 days ago" --pretty=format:"%h %ad | %s%d [%an]" -w "$@" | vim -R -'
alias glog='git log --all --graph --decorate --no-ext-diff --date=short --since="90 days ago" --pretty=format:"%h %ad | %s%d [%an]" -w "$@" | vim -R -'
